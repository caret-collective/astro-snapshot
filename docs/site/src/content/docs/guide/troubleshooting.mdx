...
Here's some common issues and their solutions. If your problem isn't listed here, [open an issue on GitHub](https://github.com/caret-collective/astro-snapshot/issues) and I'll see if I can help.
...
:::note
[This issue](https://github.com/caret-collective/astro-snapshot/issues/26) was fixed in [**v2.2.0**](/changelog/version/v2-2-0). If you're on [v2.1.0](/changelog/version/v2-1-0) or lower, upgrade to resolve it.
:::
